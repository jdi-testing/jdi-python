...
from tests.jdi_uitest_web_examples.main.enums.enums import HeaderMenu, HeaderSolutionsMenu
from tests.jdi_uitest_web_examples.main.site.epam.pages import (
    CareerPage,
    HomePage,
    JobDescriptionPage,
    JobListingPage,
...
class EpamSite(WebSite):
    ...
    multiple_header_menu = Menu(
        by_menu_levels_locators=[
