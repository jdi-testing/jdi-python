...
from tests.jdi_uitest_web_examples.main.site.epam.add_cv_form import AddCVForm, JobFilter
...
class JobListingPage(WebPage):
    def __init__(self, url, title, url_template=None, url_check_type=None, title_check_type=None):
        super(JobListingPage, self).__init__(
            url=url,
            title=title,
            url_template=url_template,
            url_check_type=url_check_type,
            title_check_type=title_check_type,
        )
